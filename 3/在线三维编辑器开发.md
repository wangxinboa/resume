...
&emsp;还有一个模型零件爆炸效果，起因是因为技术群里看到有人面试的时候，被要了这个，当事人感觉可能是在白嫖，没了结果，我处于好奇，就简单实现了一下:[效果视频链接(因为是直接部署在 git 上，所以加载可能较慢）](https://wangxinboa.github.io/react_project/resume/3-4/mp4_1.mp4)。
