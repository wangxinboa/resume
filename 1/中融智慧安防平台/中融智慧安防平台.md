...
&emsp;[简单操作视频链接（因为是直接部署在 git 上，所以加载可能较慢）](https://wangxinboa.github.io/react_project/resume/1-3/mp4_1.mp4)。
...
<img src='https://wangxinboa.github.io/react_project/resume/1-3/img1.jpg' width="500" />

&emsp;联网报警

<img src='https://wangxinboa.github.io/react_project/resume/1-3/img2.jpg' width="500" />

2. 组件

&emsp;点击标题控制内容的展示与否，原理简单的来说，就是先获取兄弟节点的高度，然后进行高度和透明度变化的js动画

<img src='https://wangxinboa.github.io/react_project/resume/1-3/gif1.gif' width="500" />

&emsp;按钮样式组件

<img src='https://wangxinboa.github.io/react_project/resume/1-3/img3.jpg' width="500" />

&emsp;数据线条及相关动画

<img src='https://wangxinboa.github.io/react_project/resume/1-3/gif2.gif' width="500" />

3. 图表，使用 bizchart 创建图表，主要是自动显示 tooltip 的动画，宽高容器的自适应以及颜色的调整

<img src='https://wangxinboa.github.io/react_project/resume/1-3/img4.jpg' width="500" />

### 三维

1. 行政区的边界线，主要是使用了 three 的[导管模型](https://threejs.org/docs/index.html#api/zh/geometries/TubeGeometry)，根据行政地区边界的经纬度参数创建

<img src='https://wangxinboa.github.io/react_project/resume/1-3/img5.jpg' width="330" />
...
<img src='https://wangxinboa.github.io/react_project/resume/1-3/img6.jpg' width="330" />

* 3D文字标注创建

&emsp;使用的是[three的3D文字模型](https://threejs.org/examples/?q=text#webgl_geometry_text)

<img src='https://wangxinboa.github.io/react_project/resume/1-3/img7.jpg' width="330" />

* 图片标注创建、视频标注创建

&emsp;其实都是矩形，只是在矩阵上贴上图片和视频的区别

<img src='https://wangxinboa.github.io/react_project/resume/1-3/img8.jpg' width="330" />
...
<img src='https://wangxinboa.github.io/react_project/resume/1-3/img9.jpg' width="330" />
